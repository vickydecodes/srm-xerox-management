...
export const adminRoutes = {
  ...
  routes: [
    ...
    },
    {
      ...
      description: "Shop administrator controls and management.",
      icon: <IconUser className="h-5 w-5 shrink-0" />,
      element: <ShopAdmin />,
    },
    {
      ...
      description: "Staff administrator controls and management.",
      icon: <IconUser className="h-5 w-5 shrink-0" />,
      element: <StaffAdmin />,
    },
    {
      ...
      description: "Manage department administrators and their details.",
      icon: <IconUser className="h-5 w-5 shrink-0" />,
    ...
    {
      path: "/super_admin/credits",
      label: "Credit Tracker",
      title: "Credit Tracking & Balances",
      description:
        "Track credit allocations, department spending, user spending, and credit payments.",
