...
import { staffCreateSchema, staffEditSchema } from "./staff-admin.schema";
...
export const Edit = ({ staff, submitFn = () => {}, closeModal = () => {} } = {}) => {
  const form = useForm({
  ...
  return (
    <DialogContent className="sm:max-w-[425px] pe-10">
      <DialogHeader>
        <DialogTitle>Are you sure?</DialogTitle>
        <DialogDescription>
          <strong>Note:</strong> This will restore the staff member and all related data.
        </DialogDescription>
      </DialogHeader>
