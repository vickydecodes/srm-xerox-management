...
export const useInventoryProductColumns = (inventoryProducts) => {
  return [
    ...
    },
    {
      ...
      cell: ({ row }) => (
        <span>{Number(row.getValue("price") || 0).toFixed(2)}</span>
      ),
    },
    {
      accessorKey: "active",
        ...
        return (
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end">
              <DropdownMenuItem
                onClick={() => inventoryProducts.openEdit(inventoryProduct)}
              >
                Edit
              </DropdownMenuItem>
              ...
              <DropdownMenuItem
                onClick={() =>
                  inventoryProducts.openActiveStatus(
              ...
              <DropdownMenuItem
                variant="destructive"
                onClick={() =>
                  inventoryProducts.openErase(inventoryProduct._id)
                }
              >
                Erase Permanently
              </DropdownMenuItem>
              <DropdownMenuItem
                onClick={() =>
                  inventoryProducts.openRetrieve(inventoryProduct._id)
                }
              >
                Retrieve
              </DropdownMenuItem>
