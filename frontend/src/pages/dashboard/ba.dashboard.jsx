  ...
  const kpis = [
    {
      ...
      description: "Branch completed sales value",
    ...
    },
    {
      ...
      description: "Transactions in branch",
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <Card className="border border-border shadow-sm bg-card">
            <CardHeader>
              ...
              <CardDescription>Branch paid sales over the last 6 months.</CardDescription>
            </CardHeader>
            <CardContent>
          ...
          <Card className="border border-border shadow-sm bg-card">
            <CardHeader className="flex flex-row items-center justify-between">
              <div>
                ...
                <CardDescription>Latest checkout logs in this branch.</CardDescription>
              </div>
              <Button
                variant="outline"
                size="sm"
                onClick={() => navigate("/branch_admin/bill")}
